    ...
    return (
        <>
            <Box sx={{ display: 'flex', justifyContent: 'center' }}>
                ...
                <Box sx={{ marginTop: '160px', marginBottom: '140px', width: '96vw', height: '500px', textAlign: 'center', backgroundColor: 'white' }}>
                    <h1 className="poppins-regular" style={{ paddingTop: '50px' }}>Other Info</h1>
