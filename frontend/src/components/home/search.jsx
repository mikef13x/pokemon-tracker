...
export default function LetsGetStarted() {
    return (
        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginTop: '100px' }}>
           <Typography sx={{color: 'white', fontSize: '32px',  '@media (max-width: 1300px)': {
                fontSize: '24px', // Adjust the font size for smaller screens
                marginTop:'-50px'
            },}}>
         <span className='poppins-regular'> Welcome to PokeTrack</span>
           </Typography>
           <Typography sx={{color: 'white', fontSize: '24px', textAlign:"center", '@media (max-width: 1300px)': {
                fontSize: '16px',
           ...
           <Typography sx={{color:'white', marginTop:'100px', animation: 'fadeInOut 2s infinite',  '@media (max-width: 600px)': {
